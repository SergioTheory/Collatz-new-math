...
barriers, and bridge to Shaik's unconditional natural-density polylogarithmic
...
The deterministic $2$-adic transport assembly (first-passage reversal over decreasing thresholds) was recently shown by Shaik (August 2026) to unconditionally bound the measure of exceptional trajectories in natural density. Our exact conditional transport (Theorem~\ref{thm:exact_conditional_transport}) natively acts as the strict topological input for that assembly.
...
the typical decay (proven by Tao), the natural-density descent (proven in natural density by Shaik; the Tao-to-natural-density bridges of Allikvere and Mazur remain unpublished), the Hausdorff dimension of the exceptional set
