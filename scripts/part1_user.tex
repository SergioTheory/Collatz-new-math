...
supplies the rigorous theory (LDP duality, dressed vacua, exact $2$-adic
transport, unconditional Hausdorff dimension drop) of the structures mapped here.
\smallskip
...
The full Zone~2 catalog (913 entries, \texttt{zone2\_shifts\_full.csv}, \texttt{expand\_913.json}), KL derivation, beam-search death logs, and pseudocodes are in the Supplementary Material.
